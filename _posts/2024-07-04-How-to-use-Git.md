...
通过这些步骤，你可以有效地使用 Git 分支来管理代码开发过程。
...
以下是一个完整的操作示例，演示了如何根据 `git log` 恢复到特定的提交：
...
2. **找到要恢复的提交哈希值**，例如 `abcdef1234567890abcdef1234567890abcdef12`。

3. **使用 `git reset` 回退到特定提交**：
